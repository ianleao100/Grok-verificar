...
/* 
  ...
  - Nenhuma chamada automática de navigator.geolocation neste nível.
  - A permissão só será solicitada se o usuário clicar no botão "Usar minha localização" 
    dentro do componente AddressManager ou MapComponent.
*/
