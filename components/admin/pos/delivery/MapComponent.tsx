...
import { Navigation, Maximize2, Map as MapIcon, Search, MapPin, Locate } from 'lucide-react';
...
const MapComponent = React.memo(({ 
    ...
    // UX: Localização Manual (Só pede permissão aqui)
    const handleGetCurrentLocation = () => {
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            (error) => {
                ...
                // UX: Fail silently, keep manual search active
            }
        );
    };
        ...
        <div className="relative flex-1 w-full bg-slate-200 rounded-2xl overflow-hidden border border-gray-300 dark:border-gray-700 shadow-md min-h-[300px]">
            ...
            <div className="absolute bottom-4 right-4 z-[400] flex flex-col gap-2">
                <button 
                    ...
                    className="p-3 bg-white rounded-xl shadow-lg text-slate-600 hover:text-[#EA2831] hover:scale-110 transition-all border border-gray-100"
