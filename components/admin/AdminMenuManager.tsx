                      ...
                      {catProducts.length > 0 ? (
                          <div className="grid grid-cols-1 gap-4">
                              {catProducts.map(product => {
                                  ...
                                  // Lógica de Alerta de Estoque Baixo (Entre Mínimo e Mínimo + 20%)
                                  // Apenas se estiver com controle ligado e disponível
                                  const isLowStock = product.stockControlEnabled && 
                                                     product.available && 
                                                     (product.currentStock || 0) <= (product.minStock || 0) * 1.2 && 
                                  ...
                                  return (
                                      <div 
                                        ...
                                        className={`relative bg-white dark:bg-surface-dark rounded-[24px] border transition-all duration-200 flex items-center p-4 cursor-pointer group hover:shadow-lg ${
                                            !product.available 
                                                ? 'border-gray-100 dark:border-gray-800 opacity-80 bg-gray-50/50' 
                                                : isLowStock 
                                                    ? 'border-orange-300 dark:border-orange-700 shadow-sm ring-1 ring-orange-100 dark:ring-orange-900/30' 
                                      ...
                                      >
                                          <div className="relative shrink-0">
                                              ...
                                              {!product.available && (
                                                  <div className="absolute inset-0 flex items-center justify-center bg-black/20 rounded-[20px] backdrop-blur-[1px]">
                                                      <div className="bg-white/90 p-1.5 rounded-full shadow-sm"><AlertTriangle className="w-5 h-5 text-slate-500" /></div>
                                                  </div>
                                              )}
                                          </div>
                                          ...
                                          <div className="flex-1 flex flex-col justify-center px-6 min-w-0">
                                              <div className="flex items-center gap-2 mb-1">
                                                  ...
                                                  {isLowStock && (
                                                      <div className="flex items-center gap-1 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 px-2 py-0.5 rounded-lg border border-orange-200 dark:border-orange-800 animate-pulse">
                                                          <AlertTriangle className="w-3 h-3" />
                                                          <span className="text-[9px] font-black uppercase tracking-wider">Estoque Baixo</span>
                                                      </div>
                                                  )}
                                              </div>
                                              ...
                                              <div className="flex items-center gap-3">
                                                  ...
                                                  {product.stockControlEnabled && (
                                                      <span className="text-[10px] font-bold text-slate-400 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded">
                                          ...
                                          {/* AÇÕES CRÍTICAS - Isolamento de Eventos - Botões Padronizados e Container Ajustado */}
                                          <div 
                                            className="flex items-center gap-2 ml-auto pl-6 border-l border-gray-100 dark:border-gray-800 relative z-50 cursor-default"
                                            onClick={(e) => {
                                                e.preventDefault(); 
                                                e.stopPropagation(); 
                                            }}
                                          >
                                              <button 
                                                  ...
                                                  className="size-8 flex items-center justify-center bg-white dark:bg-surface-dark border border-gray-200 dark:border-gray-700 rounded-lg text-[#EA1D2C] hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-gray-800 transition-all shadow-sm active:scale-95 pointer-events-auto"
                                                  title="Editar"
                                              >
