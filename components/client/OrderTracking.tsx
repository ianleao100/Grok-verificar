    ...
    return (
        <div className="fixed inset-0 z-[100] bg-white dark:bg-background-dark flex flex-col animate-[slideUp_0.3s_ease-out]">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8">
                {/* PWA Install Banner */}
                {showInstallPrompt && (
                    <div className="mb-8 p-4 bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl text-white shadow-lg relative overflow-hidden animate-[fadeIn_0.5s]">
                        <button 
                        ...
                        <div className="flex items-start gap-4">
                            <div className="p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                                <Download className="w-6 h-6 text-[#EA2831]" />
                            </div>
                            <div className="flex-1">
                                <h4 className="font-bold text-sm mb-1">Acompanhe com facilidade!</h4>
                                <p className="text-xs text-slate-300 leading-relaxed mb-3">
                                    Adicione nosso app à sua tela de início para notificações em tempo real.
                                </p>
                                <button className="px-4 py-2 bg-white text-slate-900 text-xs font-black uppercase tracking-wider rounded-lg shadow-sm active:scale-95 transition-transform hover:bg-gray-50">
                                    Instalar App
                                </button>
                            </div>
                        </div>
