    ...
    const handleGetCurrentLocation = () => {
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            (error) => {
                ...
                // UX: Não exibir alerta intrusivo, manter busca manual
            }
        );
    };
                    ...
                    <div className="relative w-full h-56 bg-slate-200 dark:bg-zinc-800 rounded-xl overflow-hidden shadow-sm border border-gray-300 dark:border-gray-600 isolate">
                        ...
                        <div className="absolute bottom-3 right-3 flex flex-col gap-2 z-[400]">
                            <button 
                                ...
                                className="w-8 h-8 bg-white dark:bg-surface-dark rounded-lg shadow flex items-center justify-center text-slate-600 dark:text-gray-300 hover:text-[#ea2a33] transition-colors"
